...
psql -h localhost -p 5432 -U postgres -d librarymanagementsystem_test -c "CREATE TABLE IF NOT EXISTS public.book (
...
psql -h localhost -p 5432 -U postgres -d librarymanagementsystem_test -c "ALTER TABLE IF EXISTS public.book OWNER to postgres;"

psql -h localhost -p 5432 -U postgres -d librarymanagementsystem_test -c "CREATE TABLE IF NOT EXISTS public.employee (
...
psql -h localhost -p 5432 -U postgres -d librarymanagementsystem_test -c "ALTER TABLE IF EXISTS public.employee OWNER to postgres;"

psql -h localhost -p 5432 -U postgres -d librarymanagementsystem_test -c "CREATE TABLE IF NOT EXISTS public.student (
...
psql -h localhost -p 5432 -U postgres -d librarymanagementsystem_test -c "ALTER TABLE IF EXISTS public.student OWNER to postgres;"

psql -h localhost -p 5432 -U postgres -d librarymanagementsystem_test -c "CREATE TABLE IF NOT EXISTS public.book_borrow (
...
psql -h localhost -p 5432 -U postgres -d librarymanagementsystem_test -c "ALTER TABLE IF EXISTS public.book_borrow OWNER to postgres;"